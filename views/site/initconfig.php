...
<div class="register-container animated fadeInDown col-md-3 col-md-offset-4">
    <div class="registerbox bg-white">
        <div class="registerbox-title">Config</div>
        <div class="registerbox-caption ">Please fill in your <span>Mysql Database</span> config</div>
...
<script src="/apps/views/site/initconfig.js"></script>
<script>
